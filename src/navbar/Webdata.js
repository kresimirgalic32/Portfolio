          ...
          <div className="wd-navbar">
            <div className="wd-navbar-left">
              ...
              <h2 className="wd-text">
                ...
                and muted. Navbar/Dropdown is placed at the top of the screen.
                Font size is 5vw (5 view width) as is line height, font family
                is "Raleway" and color is Ivory.
              </h2>
              ...
              <h2 className="wd-text">
                ...
                same timeline as in the non mobile version with a background of
                "#4d270a".
              </h2>
              <h1 className="wd-text-2">Projects</h1>
              <h2 className="wd-text">
                Background colour for projects page is "#3d0804". Projects also
                has two flex boxes. First one has all my programming projects
                and the second one has all the 3D modelling projects.
              </h2>
              <h1 className="wd-text-2">Web Data</h1>
              <h2 className="wd-text">
                Web Data was meant to be a more in depth look into my webpage.
            ...
            <div className="wd-navbar-right">
              ...
              <h2 className="wd-text">
                ...
                navbar, there is a drop down button which adds some new styling.
                That new styling does "display: none;" for everything, adds a
                new background colour "Royal Blue Dark" "#0a2472" and
                "flex-direction" is set to "column".
              </h2>
              <h1 className="wd-text-2">Button</h1>
              <h2 className="wd-text">
                Every button's onClick function was coded with React's useState.
                Dropdown for navbar and timeline has an SVG background image.
              </h2>
              ...
              <h2 className="wd-text">
                There are 2 animations and both increase opacity on refresh of
                the page.
              </h2>
              <h1 className="wd-text-2">Google Fonts</h1>
              <h2 className="wd-text">
                Google fonts was added through "google-webfonts-helper" API.
                Fonts added: Raleway.
              </h2>
            </div>
          </div>
