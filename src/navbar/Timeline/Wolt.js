...
const Wolt = () => {
  return (
    <div className="wrap">
      <h1 className="company">WOLT</h1>
      <h2 className="job"> Deliverer</h2>
      <h3 className="second-text">
        My typical workday at{" "}
        {/* <a href="https://wolt.com/" target="popup" className="link"> */}
        {/* <div className="inline-svg"> */}
        Wolt{" "}
        {/* <svg>
              <path
                fill="#eef0f2"
                d="M1.9 2.5h4.7L0 9l1.8 1.8 6.6-6.6V9h2.5V0h-9v2.5z"
              ></path>
            </svg>
          </div> */}
        {/* </a>{" "} */}
